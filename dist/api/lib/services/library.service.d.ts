...
export declare class LibraryService {
    ...
    validate(name: string): Observable<Response<boolean, 'validation'>>;
    getLibraries(): Observable<Response<Library[], 'libraries'>>;
    getLibrary(id: string): Observable<Response<Library, 'library'>>;
    getItems(id: string): Observable<Response<Item[], 'items'>>;
