...
import { Item, Library, Meta, Pagination, Filter, Response, Query, Return, Event } from '../models';
export declare class LibraryService {
    ...
    copyLibrary(id: string, destination: string): Observable<Response<Event, 'event'>>;
