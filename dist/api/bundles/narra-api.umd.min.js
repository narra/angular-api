...
/**
     ...
     *
     * Authors: Michal Mocnak <michal@narra.eu>
     */d.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new d},token:d,providedIn:"root"}),d.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],d.ctorParameters=function(){return[]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
     ...
     * Authors: Michal Mocnak <michal@narra.eu>
     */
var y=function(){function e(e,t){this.http=e,this.serverService=t}return e.prototype.getConnectors=function(e){return this.http.get(this.serverService.query("connectors",e)).pipe(o.retry(1),o.catchError(h.handleError))},e}();y.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new y(r.ɵɵinject(n.HttpClient),r.ɵɵinject(d))},token:y,providedIn:"root"}),y.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],y.ctorParameters=function(){return[{type:n.HttpClient},{type:d}]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
     ...
     * Authors: Michal Mocnak <michal@narra.eu>
     */
var v=function(){function e(e,t){this.http=e,this.serverService=t}return e.prototype.getEvents=function(e,t){return void 0===e&&(e="me"),this.http.get(this.serverService.query("events/"+e,t)).pipe(o.retry(1),o.catchError(h.handleError))},e}();v.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new v(r.ɵɵinject(n.HttpClient),r.ɵɵinject(d))},token:v,providedIn:"root"}),v.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],v.ctorParameters=function(){return[{type:n.HttpClient},{type:d}]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
...
/**
     ...
     * Authors: Michal Mocnak <michal@narra.eu>
     */
var l=function(){function e(e,t){this.http=e,this.serverService=t,this.httpOptions={headers:new n.HttpHeaders({"Content-Type":"application/json"})}}return e.prototype.check=function(e,t){return this.http.post(this.serverService.query("items/check",t),{url:e},this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.addItems=function(e,t){return this.http.post(this.serverService.query("items/new",t),{candidates:e},this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.getItem=function(e,t){return this.http.get(this.serverService.query("items/"+e,t)).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.addItemMeta=function(e,t,r){return this.http.post(this.serverService.query("items/"+e+"/metadata/new",r),t,this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.updateItemMeta=function(e,t,r){return this.http.post(this.serverService.query("items/"+e+"/metadata/"+t.name+"/update",r),t,this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.deleteItemMeta=function(e,t){return this.http.get(this.serverService.query("items/"+e+"/metadata/"+t.name+"/delete?generator="+t.generator)).pipe(o.retry(1),o.catchError(h.handleError))},e}();l.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new l(r.ɵɵinject(n.HttpClient),r.ɵɵinject(d))},token:l,providedIn:"root"}),l.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],l.ctorParameters=function(){return[{type:n.HttpClient},{type:d}]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
     ...
     * Authors: Michal Mocnak <michal@narra.eu>
     */
var g=function(){function e(e,t){this.http=e,this.serverService=t,this.httpOptions={headers:new n.HttpHeaders({"Content-Type":"application/json"})}}return e.prototype.validate=function(e,t){return this.http.post(this.serverService.query("libraries/validate",t),{name:e},this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.getLibraries=function(e){return this.http.get(this.serverService.query("libraries",e)).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.getLibrary=function(e,t){return this.http.get(this.serverService.query("libraries/"+e,t)).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.getItems=function(e,t,r,n){return this.http.get(this.serverService.query("libraries/"+e+"/items",t,r,n)).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.addLibrary=function(e,t){return this.http.post(this.serverService.query("libraries/new",t),e,this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.updateLibrary=function(e,t){return this.http.post(this.serverService.query("libraries/"+e.id+"/update",t),e,this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.deleteLibrary=function(e){return this.http.get(this.serverService.query("libraries/"+e+"/delete")).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.addLibraryMeta=function(e,t,r){return this.http.post(this.serverService.query("libraries/"+e+"/metadata/new",r),t,this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.updateLibraryMeta=function(e,t,r){return this.http.post(this.serverService.query("libraries/"+e+"/metadata/"+t.name+"/update",r),t,this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.deleteLibraryMeta=function(e,t){return this.http.get(this.serverService.query("libraries/"+e+"/metadata/"+t.name+"/delete")).pipe(o.retry(1),o.catchError(h.handleError))},e}();g.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new g(r.ɵɵinject(n.HttpClient),r.ɵɵinject(d))},token:g,providedIn:"root"}),g.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],g.ctorParameters=function(){return[{type:n.HttpClient},{type:d}]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
...
/**
     ...
     * Authors: Michal Mocnak <michal@narra.eu>
     */
var j=function(){function e(e,t){this.http=e,this.serverService=t}return e.prototype.getProviders=function(){return this.http.get(this.serverService.apiServer+"/auth/providers").pipe(o.retry(1),o.catchError(h.handleError))},e}();j.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new j(r.ɵɵinject(n.HttpClient),r.ɵɵinject(d))},token:j,providedIn:"root"}),j.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],j.ctorParameters=function(){return[{type:n.HttpClient},{type:d}]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
...
/**
     ...
     * Authors: Michal Mocnak <michal@narra.eu>
     */
var q=function(){function e(e,t){this.http=e,this.serverService=t}return e.prototype.upload=function(e){var t=new FormData;return t.append("file",e),this.http.post(this.serverService.query("upload"),t,{reportProgress:!0,observe:"events"}).pipe(o.retry(1),o.catchError(h.handleError))},e}();q.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new q(r.ɵɵinject(n.HttpClient),r.ɵɵinject(d))},token:q,providedIn:"root"}),q.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],q.ctorParameters=function(){return[{type:n.HttpClient},{type:d}]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
     ...
     * Authors: Michal Mocnak <michal@narra.eu>
     */
var H=function(){function e(e,t){this.http=e,this.serverService=t,this.httpOptions={headers:new n.HttpHeaders({"Content-Type":"application/json"})}}return e.prototype.getLoggedUser=function(e){return this.http.get(this.serverService.query("users/me",e)).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.getUsers=function(e){return this.http.get(this.serverService.query("users",e)).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.getUser=function(e,t){return this.http.get(this.serverService.query("users/"+e,t)).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.deleteUser=function(e){return this.http.get(this.serverService.query("users/"+e+"/delete")).pipe(o.retry(1),o.catchError(h.handleError))},e.prototype.updateUser=function(e,t){return this.http.post(this.serverService.query("users/"+e.username+"/update",t),e,this.httpOptions).pipe(o.retry(1),o.catchError(h.handleError))},e}();H.ɵprov=r.ɵɵdefineInjectable({factory:function(){return new H(r.ɵɵinject(n.HttpClient),r.ɵɵinject(d))},token:H,providedIn:"root"}),H.decorators=[{type:r.Injectable,args:[{providedIn:"root"}]}],H.ctorParameters=function(){return[{type:n.HttpClient},{type:d}]};
/**
     * @license
     *
     * Copyright (C) 2020 narra.eu
